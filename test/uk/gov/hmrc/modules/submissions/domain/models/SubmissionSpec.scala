...
import uk.gov.hmrc.modules.submissions.SubmissionsTestData._
...
class SubmissionSpec extends AnyWordSpec with Matchers {
    ...
    "submission questionIdsOfInterest app name" in {
        submission.latestInstance.answersToQuestions(submission.questionIdsOfInterest.applicationNameId) shouldBe TextAnswer("name of software")
    }
