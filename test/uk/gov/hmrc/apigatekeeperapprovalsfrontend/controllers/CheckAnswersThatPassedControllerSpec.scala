...
class CheckAnswersThatPassedControllerSpec extends AbstractControllerSpec {
  ...
  "checkAnswersThatPassedPage" should {
    "return 200" in new Setup {
      ...
      val result = controller.checkAnswersThatPassedPage(applicationId)(using fakeRequest)
  ...
  "checkAnswersThatPassedAction" should {
    ...
    "return bad request when sending an empty submit-action" in new Setup {
      ...
      val result = controller.checkAnswersThatPassedAction(applicationId)(using fakeRequest)
