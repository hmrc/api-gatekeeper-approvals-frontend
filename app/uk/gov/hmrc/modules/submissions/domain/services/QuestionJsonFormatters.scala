...
import uk.gov.hmrc.modules.common.services.MapJsonFormatters
import uk.gov.hmrc.modules.common.services.NonEmptyListFormatters

trait QuestionJsonFormatters extends StatementJsonFormatters with MapJsonFormatters with NonEmptyListFormatters {
