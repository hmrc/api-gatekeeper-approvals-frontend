...
class CheckAnswersThatPassedController @Inject() (
  ...
  def checkAnswersThatPassedPage(applicationId: ApplicationId): Action[AnyContent] = strideAdvancedUserWithApplicationAndSubmission(applicationId) { implicit request =>
