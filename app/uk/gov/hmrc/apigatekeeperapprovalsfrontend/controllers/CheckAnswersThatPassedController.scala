...
class CheckAnswersThatPassedController @Inject() (
  ...
  def checkAnswersThatPassedAction(rawApplicationId: java.util.UUID): Action[AnyContent] = updateActionStatus(ReviewAction.CheckPassedAnswers)(rawApplicationId)
}
